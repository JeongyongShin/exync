...
let find = [99,111,110,116,101,110,116,45,108,101,110,103,116,104,58];

function getBodyBinaryData(arr, len){
	var bData = [];
	var _len = parseInt(len);
	var isData = false;
	for(var i=0; i<arr.length; i++){
		if(isData && len > 0){
			bData.push(arr[i]/*.toString(16)*/);
			len--;
		}
            ...
            switch (frame.command) {
              ...
              case "MESSAGE":
                ...
                if (onreceive) {
                  ...
                  //frame.binary = getBodyBinaryData(arr, frame.headers['content-length']);

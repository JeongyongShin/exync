...
class AAS2OPCUA:
    ...
    async def write_syscfg_json(self):
        #print('2 Number of arguments:'+len(sys.argv))
                ...
                for sm_elem_item in sm_elem:
                    if sm_elem_item.tag.endswith('submodelElementCollection'):
                        ...
                        for sub_elem in sm_elem_item:
                            ...
                            if sub_elem.tag.endswith('value'):
    ...
    async def parse_aas(self):
        ...
        for shell in self.shells:
            ...
            if 'idShort' in shell_info and 'identification' in shell_info:
                ...
                #await self.add_aas_namespaces(ns_index, shell_info['identification'], shell_info['idShort'])
                #ns_index += 1

                if shell_info['identification'] != 'http://nestfield.co.kr/ids/aas/CloudDataSolution':
                    continue;
                ...
                if 'sm_id_list' in shell_info:
                    ...
                    for sm_id in shell_info['sm_id_list']:
                        ...
                        if sm_id != 'aas.nest.io/ids/sm/EdgeGWSolution/1/1/346U4845FG12':
                            continue
